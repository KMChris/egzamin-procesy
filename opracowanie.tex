...
\end{pytanie}
\begin{odpowiedź}
    funkcja tworząca momenty: $\mu_x (t) = \mathbb{E} (\e^{itx}), \ t \in \mathbb{R}$. \\
...
\end{pytanie}
\begin{odpowiedź}
    $A \mapsto P_{s,t} (x,A)$ są miarami prawdopodobieństwa,
    $x \mapsto P_{s,t}(x,A)$ są funkcjami mierzalnymi, \\
