...
\end{pytanie}
\begin{odpowiedź}
    Dane są $\lambda_0, \lambda_1, \lambda_2, \ldots \geq 0$
    \begin{itemize}
        ...
        \item Spełnia własność markowa dla czasu ciągłego (jak w \ref{markow},
            ale dla dowolnych czasów, nie tylko całkowitych);
        \item $\mathbb{P}(X(t + h) = n+1\mid X(t) = n) = \lambda_n h + o(h),
            \mathbb{P}(X(t+h) = n+2 \mid X(t) = n) = o(h)$ gdy $h \to 0^+$.
    \end{itemize}
\end{odpowiedź}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
