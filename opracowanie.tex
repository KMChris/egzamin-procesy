...
\DeclareMathOperator {\expVal} {\mathbf E}
...
\begin{odpowiedź}
    ...
    Niech $\mathcal{B}_{u^+} = \bigcap_{u > t} \mathcal{B}_u$.
    Prawo 0-1 Blumenthala mówi, że sigma ciało $ \mathcal{B}_{0^+}$
...
\begin{odpowiedź}
    ...
    zmiennymi losowymi takimi, że $\mathbb{E}|X|, \mathbb{E}|g(X)| < \infty$.
