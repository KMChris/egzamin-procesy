%\documentclass[4pt,twocolumn]{mwart}
%\documentclass[4pt]{scrartcl}
\documentclass[
    twocolumn,
    twoside,
    fontsize=11pt,
...
\DeclareMathSizes{60}{48}{36}{36}% A0 = 841x1189mm = 4x A4

%\documentclass[11pt,twocolumn]{article}
\usepackage[
    tmargin=10cm,
    bmargin=62cm, % tak aby była połowa na drugiej stronie
%    lmargin=10cm,
%    rmargin=54.1cm,
    inner=10cm,
    outer=54.1cm
...
\theoremstyle{break}
\newcounter {odpowiedz}
\newenvironment{odpowiedź}{\refstepcounter {odpowiedz}\vspace{-0.7em}}{\vspace{0.3em}\hrule}
